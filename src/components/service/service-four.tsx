  ...
  return (
    <div className="tp-service-3-area pt-130 pb-130">
      <div className="container">
          <div className="container container-1200" style={{ paddingTop: 80, paddingBottom: 60, display: "flex", justifyContent: "space-between", alignItems: "center", gap: "5px" }}>
